...
public class GameRendererMixin {
    ...
    @Shadow private @Nullable static Shader renderTypeEntityTranslucentEmissiveShader;
...
//        list.forEach(Program::close);
        ...
        try {
//         list1.add(Pair.of(new Shader(manager, "block", VertexFormats.POSITION_COLOR_TEXTURE_LIGHT_NORMAL), (p_172743_) -> {
//            blockShader = p_172743_;
//         }));
//         list1.add(Pair.of(new Shader(manager, "new_entity", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL), (p_172740_) -> {
//            newEntityShader = p_172740_;
//         }));
            list1.add(Pair.of(new Shader(manager, "particle", VertexFormats.POSITION_TEXTURE_COLOR_LIGHT), (p_172714_) -> {
                particleShader = p_172714_;
            }));
            list1.add(Pair.of(new Shader(manager, "position", VertexFormats.POSITION), (p_172711_) -> {
                positionShader = p_172711_;
            }));
            list1.add(Pair.of(new Shader(manager, "position_color", VertexFormats.POSITION_COLOR), (p_172708_) -> {
                positionColorShader = p_172708_;
            }));
//         list1.add(Pair.of(new Shader(manager, "position_color_lightmap", VertexFormats.POSITION_COLOR_LIGHTMAP), (p_172705_) -> {
//            positionColorLightmapShader = p_172705_;
//         }));
            list1.add(Pair.of(new Shader(manager, "position_color_tex", VertexFormats.POSITION_COLOR_TEXTURE), (p_172702_) -> {
                positionColorTexShader = p_172702_;
            }));
//         list1.add(Pair.of(new Shader(manager, "position_color_tex_lightmap", VertexFormats.POSITION_COLOR_TEXTURE_LIGHTMAP), (p_172699_) -> {
//            positionColorTexLightmapShader = p_172699_;
//         }));
            list1.add(Pair.of(new Shader(manager, "position_tex", VertexFormats.POSITION_TEXTURE), (p_172696_) -> {
                positionTexShader = p_172696_;
            }));
            list1.add(Pair.of(new Shader(manager, "position_tex_color", VertexFormats.POSITION_TEXTURE_COLOR), (p_172693_) -> {
                positionTexColorShader = p_172693_;
            }));
            list1.add(Pair.of(new Shader(manager, "position_tex_color_normal", VertexFormats.POSITION_TEXTURE_COLOR_NORMAL), (p_172690_) -> {
                positionTexColorNormalShader = p_172690_;
            }));
//         list1.add(Pair.of(new Shader(manager, "position_tex_lightmap_color", VertexFormats.POSITION_TEXTURE_LIGHTMAP_COLOR), (p_172687_) -> {
//            positionTexLightmapColorShader = p_172687_;
//         }));
            list1.add(Pair.of(new Shader(manager, "rendertype_solid", VertexFormats.POSITION_COLOR_TEXTURE_LIGHT_NORMAL), (p_172684_) -> {
                renderTypeSolidShader = p_172684_;
            }));
            list1.add(Pair.of(new Shader(manager, "rendertype_cutout_mipped", VertexFormats.POSITION_COLOR_TEXTURE_LIGHT_NORMAL), (p_172681_) -> {
                renderTypeCutoutMippedShader = p_172681_;
            }));
            list1.add(Pair.of(new Shader(manager, "rendertype_cutout", VertexFormats.POSITION_COLOR_TEXTURE_LIGHT_NORMAL), (p_172678_) -> {
                renderTypeCutoutShader = p_172678_;
            }));
            list1.add(Pair.of(new Shader(manager, "rendertype_translucent", VertexFormats.POSITION_COLOR_TEXTURE_LIGHT_NORMAL), (p_172675_) -> {
                renderTypeTranslucentShader = p_172675_;
            }));
         list1.add(Pair.of(new Shader(manager, "rendertype_translucent_moving_block", VertexFormats.POSITION_COLOR_TEXTURE_LIGHT_NORMAL), (p_172672_) -> {
            renderTypeTranslucentMovingBlockShader = p_172672_;
         }));
         list1.add(Pair.of(new Shader(manager, "rendertype_translucent_no_crumbling", VertexFormats.POSITION_COLOR_TEXTURE_LIGHT_NORMAL), (p_172669_) -> {
            renderTypeTranslucentNoCrumblingShader = p_172669_;
         }));
         list1.add(Pair.of(new Shader(manager, "rendertype_armor_cutout_no_cull", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL), (p_172666_) -> {
            renderTypeArmorCutoutNoCullShader = p_172666_;
         }));
            list1.add(Pair.of(new Shader(manager, "rendertype_entity_solid", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL), (p_172663_) -> {
                renderTypeEntitySolidShader = p_172663_;
            }));
            list1.add(Pair.of(new Shader(manager, "rendertype_entity_cutout", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL), (p_172660_) -> {
                renderTypeEntityCutoutShader = p_172660_;
            }));

            //No diff in these shaders
            Shader entity_no_cull = new Shader(manager, "rendertype_entity_cutout_no_cull", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL);
            list1.add(Pair.of(entity_no_cull, (p_172657_) -> {
                renderTypeEntityCutoutNoNullShader = p_172657_;
            }));
//         list1.add(Pair.of(new Shader(manager, "rendertype_entity_cutout_no_cull_z_offset", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL), (p_172654_) -> {
...
//         }));
            ...
            list1.add(Pair.of(new Shader(manager, "rendertype_item_entity_translucent_cull", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL), (p_172651_) -> {
                renderTypeItemEntityTranslucentCullShader = p_172651_;
            }));
            list1.add(Pair.of(new Shader(manager, "rendertype_entity_translucent_cull", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL), (p_172648_) -> {
                renderTypeEntityTranslucentCullShader = p_172648_;
            }));
            list1.add(Pair.of(new Shader(manager, "rendertype_entity_translucent", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL), (p_172645_) -> {
                renderTypeEntityTranslucentShader = p_172645_;
            }));
            list1.add(Pair.of(new Shader(manager, "rendertype_entity_translucent_emissive", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL), shader -> {
                renderTypeEntityTranslucentEmissiveShader = shader;
            }));
            list1.add(Pair.of(new Shader(manager, "rendertype_entity_smooth_cutout", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL), (p_172642_) -> {
                renderTypeEntitySmoothCutoutShader = p_172642_;
            }));
         list1.add(Pair.of(new Shader(manager, "rendertype_beacon_beam", VertexFormats.POSITION_COLOR_TEXTURE_LIGHT_NORMAL), (p_172639_) -> {
            renderTypeBeaconBeamShader = p_172639_;
         }));
         list1.add(Pair.of(new Shader(manager, "rendertype_entity_decal", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL), (p_172840_) -> {
            renderTypeEntityDecalShader = p_172840_;
         }));
         list1.add(Pair.of(new Shader(manager, "rendertype_entity_no_outline", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL), (p_172837_) -> {
            renderTypeEntityNoOutlineShader = p_172837_;
         }));
            list1.add(Pair.of(new Shader(manager, "rendertype_entity_shadow", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL), (p_172834_) -> {
                renderTypeEntityShadowShader = p_172834_;
            }));
         list1.add(Pair.of(new Shader(manager, "rendertype_entity_alpha", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL), (p_172831_) -> {
            renderTypeEntityAlphaShader = p_172831_;
         }));
            list1.add(Pair.of(new Shader(manager, "rendertype_eyes", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL), (p_172828_) -> {
                renderTypeEyesShader = p_172828_;
            }));
         list1.add(Pair.of(new Shader(manager, "rendertype_energy_swirl", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL), (p_172825_) -> {
            renderTypeEnergySwirlShader = p_172825_;
         }));
         list1.add(Pair.of(new Shader(manager, "rendertype_leash", VertexFormats.POSITION_COLOR_LIGHT), (p_172822_) -> {
            renderTypeLeashShader = p_172822_;
         }));
         list1.add(Pair.of(new Shader(manager, "rendertype_water_mask", VertexFormats.POSITION), (p_172819_) -> {
            renderTypeWaterMaskShader = p_172819_;
         }));
         list1.add(Pair.of(new Shader(manager, "rendertype_outline", VertexFormats.POSITION_COLOR_TEXTURE), (p_172816_) -> {
            renderTypeOutlineShader = p_172816_;
         }));
         list1.add(Pair.of(new Shader(manager, "rendertype_armor_glint", VertexFormats.POSITION_TEXTURE), (p_172813_) -> {
            renderTypeArmorGlintShader = p_172813_;
         }));
         list1.add(Pair.of(new Shader(manager, "rendertype_armor_entity_glint", VertexFormats.POSITION_TEXTURE), (p_172810_) -> {
            renderTypeArmorEntityGlintShader = p_172810_;
         }));
         list1.add(Pair.of(new Shader(manager, "rendertype_glint_translucent", VertexFormats.POSITION_TEXTURE), (p_172807_) -> {
            renderTypeGlintTranslucentShader = p_172807_;
         }));
         list1.add(Pair.of(new Shader(manager, "rendertype_glint", VertexFormats.POSITION_TEXTURE), (p_172805_) -> {
            renderTypeGlintShader = p_172805_;
         }));
         list1.add(Pair.of(new Shader(manager, "rendertype_glint_direct", VertexFormats.POSITION_TEXTURE), (p_172803_) -> {
            renderTypeGlintDirectShader = p_172803_;
         }));
         list1.add(Pair.of(new Shader(manager, "rendertype_entity_glint", VertexFormats.POSITION_TEXTURE), (p_172801_) -> {
            renderTypeEntityGlintShader = p_172801_;
         }));
         list1.add(Pair.of(new Shader(manager, "rendertype_entity_glint_direct", VertexFormats.POSITION_TEXTURE), (p_172799_) -> {
            renderTypeEntityGlintDirectShader = p_172799_;
         }));
         Shader textShader = new Shader(manager, "rendertype_text", VertexFormats.POSITION_COLOR_TEXTURE_LIGHT);
         ...
         Shader seeThroughShader = new Shader(manager, "rendertype_text_see_through", VertexFormats.POSITION_COLOR_TEXTURE_LIGHT);
         ...
         list1.add(Pair.of(new Shader(manager, "rendertype_lightning", VertexFormats.POSITION_COLOR), (p_172787_) -> {
            renderTypeLightningShader = p_172787_;
         }));
         list1.add(Pair.of(new Shader(manager, "rendertype_tripwire", VertexFormats.POSITION_COLOR_TEXTURE_LIGHT_NORMAL), (p_172785_) -> {
                renderTypeTripwireShader = p_172785_;
            }));
         Shader endPortalShader = new Shader(manager, "rendertype_end_portal", VertexFormats.POSITION);
         ...
         list1.add(Pair.of(endPortalShader, (p_172778_) -> {
            ...
            list1.add(Pair.of(new Shader(manager, "rendertype_lines", VertexFormats.LINES), (p_172774_) -> {
                renderTypeLinesShader = p_172774_;
            }));
            list1.add(Pair.of(new Shader(manager, "rendertype_crumbling", VertexFormats.POSITION_COLOR_TEXTURE_LIGHT_NORMAL), (p_172733_) -> {
